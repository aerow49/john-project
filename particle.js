!(function (e) {
  ...
  function (e, t, r) {
    ...
    (i = o),
      void 0 !== (a = "function" == typeof i ? i.call(t, r, t, e) : i) &&
        (e.exports = a),
      ...
      (o.shaderChunks = {
        ...
        rotateTexture: [
          ...
          "    #endif",
          "",
          "    vec4 rotatedTexture = texture2D( partTexture, vUv );",
        ].join("\n"),
      }),
      (o.shaders = {
        vertex: [
      ...
      (o.Group.prototype.getFromPool = function () {
        ...
        return e.length
          ? e.pop()
          : t
          ? new o.Emitter(this._poolCreationSettings)
          : null;
      }),
        ...
        for (var a, o, s, n, u = t - 1; u >= e; --u)
          (a = 4 * u),
            0 !== (n = r[a]) &&
              ...
              1 === this.direction
                ? (s += i) >= o &&
                  ((s = 0), (n = 0), this._decrementParticleCount())
                : (s -= i) <= 0 &&
                  ((s = o), (n = 0), this._decrementParticleCount()),
              (r[a] = n),
              (r[a + 1] = s),
